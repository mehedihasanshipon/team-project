...
const HouseDetails = (props) => {
   ...
   const handleBtn = (serviceId) => {
    ...
    return (
        ...
        <img style={{width:"100%", borderRadius:"3px",height:'400px'}} src={img} alt=""/>
        <div className="mx-2">
           <h5 className="mt-3 mb-2" style={{fontWeight:"700"}}>{title}</h5>
           <p style={{fontWeight:"400", fontSize:"15px"}} className="m-0 p-0">{location}</p>
           <div >
              <span style={{fontWeight:"400", fontSize:"15px"}}>{bedroom} Days</span>   
              <span style={{fontWeight:"400", fontSize:"15px"}} className="ml-4">{bathroom} Night</span>
